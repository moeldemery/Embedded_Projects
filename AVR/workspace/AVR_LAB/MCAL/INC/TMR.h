...
typedef enum {TIMER_0,TIMER_1,TIMER_2} Timer_select_t ;
...
typedef enum {DISABLE_PWM_PIN_MODE,PWM_NON_INV_MODE=2,PWM_INV_MODE} Timer_pwm_mode_t ;
typedef struct
{
	...
	Timer_pwm_mode_t		Timer_pwm_mode;
}TMR_config_t;
