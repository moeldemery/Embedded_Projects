...
/*Marco for Peripherals in ARM-CortexM  >> page: 145*/
#define RCC_GPIOA_PERIPHERAL				1
#define RCC_GPIOB_PERIPHERAL				2
#define RCC_GPIOC_PERIPHERAL				3

#define RCC_DMA1_PERIPHERAL					4
#define RCC_USART1_PERIPHERAL				5

//
//#define RCC_UART_PERIPHERAL				4
...
ErrorStatus RCC_enueripheralCLKState(u8 Copy_u8PeripheralNb , u8 Copy_u8State);		//note that If M.C has no of peripheral more that 256 > we use u16
