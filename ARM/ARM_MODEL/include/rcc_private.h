...
#define RCC_CR_CSSON_Bit			19	// CSSON: Clock security system enable >>If External Clk Source Failed >> Automatically Switch to Internal RC CLK(HSI)
#define RCC_CR_HSEBYP_Bit			18	// HSEBYP: External high-speed clock bypass >Only Enabled in case of Rc_External Clk Source
...
#define RCC_CFGR_MCO_Bit2			26	// MCO: M.C clock output	>> Output Signal from a H.W Pin
#define RCC_CFGR_MCO_Bit1			25
#define RCC_CFGR_MCO_Bit0			24
#define RCC_CFGR_USBPRE_Bit			22	// USBPRE: USB prescaler
#define RCC_CFGR_PLLMUL_Bit3		21	// PLLMUL: PLL multiplication factor
#define RCC_CFGR_PLLMUL_Bit2		20
#define RCC_CFGR_PLLMUL_Bit1		19
#define RCC_CFGR_PLLMUL_Bit0		18
#define RCC_CFGR_PLLXTPRE_Bit		17 	// PLLXTPRE: HSE divider for PLL entry
#define RCC_CFGR_PLLSRC_Bit			16	// PLLSRC: PLL entry clock source
#define RCC_CFGR_ADCPRE_Bit1		15	// ADCPRE: ADC prescaler
#define RCC_CFGR_ADCPRE_Bit0		14
#define RCC_CFGR_PPRE2_Bit2			13	// PPRE2: APB high-speed prescaler (APB2)
#define RCC_CFGR_PPRE2_Bit1			12
#define RCC_CFGR_PPRE2_Bit0			11
#define RCC_CFGR_PPRE1_Bit2			10	// PPRE1: APB low-speed prescaler (APB1)
#define RCC_CFGR_PPRE1_Bit1			9
#define RCC_CFGR_PPRE1_Bit0			8
#define RCC_CFGR_HPRE_Bit3			7	// HPRE: AHB prescaler (HKLK=AHB CLK)
#define RCC_CFGR_HPRE_Bit2			6
#define RCC_CFGR_HPRE_Bit1			5
#define RCC_CFGR_HPRE_Bit0			4
#define RCC_CFGR_SWS_Bit1			3	// SWS: System clock switch status
#define RCC_CFGR_SWS_Bit0			2
#define RCC_CFGR_SW_Bit1			1	// SW: System clock switch
...
#define RCC_CIR_PLLRDYIE_Bit		12	// PLL ready interrupt enable	>>Disable/Enable
#define RCC_CIR_HSERDYIE_Bit		11	// HSE ready interrupt enable	>>Disable/Enable
#define RCC_CIR_HSIRDYIE_Bit		10	// HSI ready interrupt enable	>>Disable/Enable
#define RCC_CIR_LSERDYIE_Bit		9 	// LSE ready interrupt enable	>>Disable/Enable
#define RCC_CIR_LSIRDYIE_Bit		8 	// LSI ready interrupt enable	>>Disable/Enable
...
#define HSE_CLK             4
#define PLL_CLK				5
#define DIVISABLE_PLL_CLK	6	//>>PLL_CLK_DIV_BY_1.5
