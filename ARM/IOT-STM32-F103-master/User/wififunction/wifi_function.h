...
#define     ESP8266_CH_HIGH_LEVEL()             GPIO_SetBits( GPIOB, GPIO_Pin_8 )
#define     ESP8266_CH_LOW_LEVEL()              GPIO_ResetBits( GPIOB, GPIO_Pin_8 )

#define     ESP8266_RST_HIGH_LEVEL()            GPIO_SetBits( GPIOB, GPIO_Pin_9 )
#define     ESP8266_RST_LOW_LEVEL()             GPIO_ResetBits( GPIOB, GPIO_Pin_9 )
